    ...
    <Section id="about">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="relative">
          <div className="relative z-10 rounded-none overflow-hidden animate-fade-in">
            <img 
          ...
          {/* Decorative elements */}
          <div className="absolute -top-4 -left-4 w-24 h-24 border-2 border-white rounded-none -z-10"></div>
          <div className="absolute -bottom-4 -right-4 w-24 h-24 border-2 border-white rounded-none -z-10"></div>
        </div>
        
        <div className="animate-fade-in animation-delay-200">
          <span className="tag bg-white/10 text-white mb-6 inline-block">About Pluria</span>
          ...
          <Button className="bg-white hover:bg-white/90 text-black uppercase tracking-widest rounded-none">
